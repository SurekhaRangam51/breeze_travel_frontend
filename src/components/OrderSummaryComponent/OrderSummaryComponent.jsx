...
import { useHotel,useFilter,useDate } from "../../context";
     ...
     return (
        <div className="os-container d-flex direction-column shadow gap">
            <div className="d-flex align-center justify-space-between br-bottom pd-small">
                <h2>Order Summary</h2>
                <button className="button btn-auth btn-close cursor-pointer d-flex align-center justify-center" onClick={handleContinueBooking}>
            ...
            <div>
                <button className="button btn-primary btn-reserve cursor" onClick={handleContinueBooking} >Continue Booking</button>
            </div>
        </div>
    )
}